...
const script = readFileSync(new URL('./js/admin_dashboard.js', import.meta.url), 'utf8');

test('admin dashboard links split css and js files', () => {
  assert.match(html, /admin_dashboard\.css/);
  assert.match(html, /js\/admin_dashboard\.js/);
});
